...
public class DepartmentControllerIT {
    ...
    void deleteDepartment_DataIntegrityException() {
        ...
        department1.removeSubEntity(department2);
        department2.removeSubEntity(department1);
    ...
    void getAncestors_Success() {
        ...
        assertThat(ancestors.get(0).getParentEntityId()).isEqualTo(grandparentId); // Assuming parentId is child of grandparentId
        ...
        assertThat(ancestors.get(1).getParentEntityId()).isNull(); // Assuming grandparentId is root department
