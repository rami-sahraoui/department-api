...
/**
 * Represents a hierarchical entity in the system using Nested Set Model attributes.
 *
...
public abstract class HierarchyBaseEntity<E extends HierarchyBaseEntity<E>> {
    ...
    /**
     * The left index in the Nested Set Model.
     */
    @Column(name = "left_index", nullable = false)
    private Integer leftIndex;

    /**
     * The right index in the Nested Set Model.
     */
    @Column(name = "right_index", nullable = false)
    private Integer rightIndex;

    /**
     * The level of the hierarchical entity in the Nested Set Model.
     */
    @Column(name = "level", nullable = false)
    private Integer level;

    /**
     * The ID of the root or master entity in the Nested Set Model.
     */
    @Column(name = "root_id")
    private Long rootId;
