...
@Service
@Slf4j
public class NestedSetDepartmentService extends NestedSetEntityService<Department, HierarchyRequestDto, HierarchyResponseDto>
implements DepartmentService {
     ...
     */
    public NestedSetDepartmentService(HierarchyBaseRepository<Department> entityRepository, HierarchyMapper<Department, HierarchyRequestDto, HierarchyResponseDto> entityMapper, JPAQueryFactory jpaQueryFactory) {
